-- Definitive fix: use #variable_conflict use_column so PostgreSQL prefers
-- table column references over the PL/pgSQL RETURNS TABLE output variable
-- named "item_id" everywhere inside the function body.
