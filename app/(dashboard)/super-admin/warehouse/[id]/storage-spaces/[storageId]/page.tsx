    ...
    if (!storageSpace) {
        return (
            <div className="text-center py-12">
                ...
                <Link href="/super-admin/warehouse">
                    <Button className="mt-4">Back to Warehouse</Button>
                </Link>
            </div>
        );
    }
        ...
        <div className="space-y-6">
            ...
            <nav className="mb-6" aria-label="Breadcrumb">
                <ol className="flex items-center text-sm text-zinc-600 space-x-2">
                    <li>
                        <Link href="/super-admin/warehouse" className="flex items-center hover:underline">
                            <ArrowLeft className="w-4 h-4 mr-1" />
                            Warehouse
                        </Link>
                    </li>
                    <li><span className="mx-2 text-zinc-400">/</span></li>
                ...
                <div className="flex items-start justify-between">
                    <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className="px-3 py-1 rounded-full text-sm font-medium bg-zinc-100 text-zinc-600">
                                Warehouse
                            </span>
                        </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-zinc-200">
                <Tabs value={activeTab} onValueChange={setActiveTab}>
                    <div className="flex items-center justify-between mb-4">
                        ...
                        {activeTab === 'items' && (
                            <div className="flex items-center gap-2">
                                ...
                                <Button onClick={() => setShowAddItems(true)} size="sm" className="items-center gap-2 sm:flex hidden">
                    ...
                    <Button onClick={() => setShowAddItems(true)} size="sm" className="items-center gap-2 mb-2 flex sm:hidden">
                        <Plus className="w-4 h-4" />
                        Add Items
                    </Button>
                    ...
                    <TabsContent value="items" className="mt-0">
                        ...
                        <BulkInventoryActionsToolbar
                            ...
                            onSetQuantity={() => { setBulkInventoryUpdateField('quantity'); setShowBulkInventoryUpdateModal(true); }}
                            onSetMinOverride={() => { setBulkInventoryUpdateField('minOverride'); setShowBulkInventoryUpdateModal(true); }}
                            onBulkUpdate={() => { setBulkInventoryUpdateField('all'); setShowBulkInventoryUpdateModal(true); }}
                        ...
                        {inventoryLoading ? (
                            ...
                            <div className="text-center py-12">
                                ...
                                <Button onClick={() => setShowAddItems(true)} variant="outline" size="sm">
                            ...
                            <div className="space-y-2">
                                {filteredInventory.map((inv: any) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <div
                                                onClick={(e) => { e.stopPropagation(); handleInventoryToggle(inv.item_id); }}
                    ...
                    <TabsContent value="logs" className="mt-0">
                        <InventoryLogsList logs={logs || []} isLoading={logsLoading} onRefresh={refetchLogs} />
                    </TabsContent>
                </Tabs>
            </div>
            ...
            <MobileSheet
                isOpen={showAddItems}
                onClose={() => { setShowAddItems(false); setSelectedItems(new Set()); setItemQuantities({}); }}
                title="Add Items to Storage Space"
                snapPoints={[0, 0.7, 0.95, 1]}
                footer={
                    selectedItems.size > 0 ? (
                        <div className="flex gap-2">
                            <Button variant="outline" onClick={() => { setShowAddItems(false); setSelectedItems(new Set()); setItemQuantities({}); }} className="flex-1">
                                Cancel
                            </Button>
                            <Button onClick={handleAddItems} className="flex-1" disabled={bulkAssignMutation.isPending}>
                        ...
                        <AlertDialogDescription>
                            ...
                            {inventory && inventory.length > 0 && (
                                <span className="block mt-2 text-red-600">
                                    Warning: This storage space contains {inventory.length} item{inventory.length !== 1 ? 's' : ''}. All associated inventory data will be deleted.
                                </span>
                            )}
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
                        <AlertDialogCancel disabled={deleteStorageSpaceMutation.isPending}>Cancel</AlertDialogCancel>
                        <AlertDialogAction
                            onClick={async () => {
                                try {
            ...
            <AlertDialog open={showBulkRemoveDialog} onOpenChange={setShowBulkRemoveDialog}>
                <AlertDialogContent>
                    ...
                    <AlertDialogFooter>
                        <AlertDialogCancel disabled={bulkRemoveItemsMutation.isPending}>Cancel</AlertDialogCancel>
                        <AlertDialogAction
