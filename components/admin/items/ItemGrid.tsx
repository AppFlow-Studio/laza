                    ...
                    <AlertDialogContent className="sm:max-w-[425px]">
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription className="text-base text-zinc-600 pt-2">
                                Are you sure you want to delete <span className="font-semibold text-zinc-900">"{itemToDelete?.name}"</span>? This action cannot be undone and will permanently remove the item from your inventory.
                            </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter className="mt-6">
                            <AlertDialogCancel onClick={handleCancelDelete} className="bg-zinc-100 hover:bg-zinc-200 text-zinc-700">
                                Cancel
                            </AlertDialogCancel>
                            <AlertDialogAction
