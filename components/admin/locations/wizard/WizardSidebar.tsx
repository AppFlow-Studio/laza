...
const STEPS: WizardStep[] = [
    { number: 1, title: 'Location Details', description: 'Name, address, status' },
    { number: 2, title: 'Storage Spaces', description: 'Add storage areas' },
    { number: 3, title: 'Assign Items', description: 'Stock each space' },
    { number: 4, title: 'Review & Create', description: 'Confirm and submit' },
];
...
export default function WizardSidebar({ currentStep, completedSteps, onStepClick }: WizardSidebarProps) {
